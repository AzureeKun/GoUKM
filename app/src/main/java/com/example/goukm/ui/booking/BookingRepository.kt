...
data class Booking(
    ...
    val driverVehiclePlateNumber: String = "",
    val driverPhone: String = "",
    val driverProfileUrl: String = "",
    val driverCarBrand: String = "",
        ...
        return try {
            bookingsCollection.document(bookingId).update(
                mapOf(
                    ...
                    "driverVehicleType" to offer.vehicleType,
                    "driverVehiclePlateNumber" to offer.vehiclePlateNumber,
                    "driverPhone" to offer.phoneNumber,
                    "driverProfileUrl" to offer.driverProfileUrl,
                    "driverCarBrand" to offer.carBrand,
                    "driverCarColor" to offer.carColor,
        ...
        return try {
            ...
            if (doc.exists()) {
                val booking = Booking(
                    ...
                    driverVehicleType = doc.getString("driverVehicleType") ?: "",
                    driverVehiclePlateNumber = doc.getString("driverVehiclePlateNumber") ?: "",
                    driverPhone = doc.getString("driverPhone") ?: "",
                    driverProfileUrl = doc.getString("driverProfileUrl") ?: "",
                    driverCarBrand = doc.getString("driverCarBrand") ?: "",
                    driverCarColor = doc.getString("driverCarColor") ?: "",
